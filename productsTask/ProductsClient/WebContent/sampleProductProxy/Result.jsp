...
<jsp:useBean id="sampleProductProxyid" scope="session" class="ru.maslenkin.ws.ProductProxy" />
<%
...
case 10:
        gotMethod = true;
        ru.maslenkin.ws.Product getProduct10mtemp = sampleProductProxyid.getProduct();
